        ...
        <>
            ...
            <div className="flex flex-row items-center justify-center min-h-screen w-screen bg-white pt-20">
                ...
                <div className="w-[55%] text-center mx-auto flex flex-col items-center gap-3">
                    ...
                    <a
                        href="/signup"
                        className="bg-primary px-6 py-3 rounded-md hover:translate-y-[-3px] hover:bg-secondary hover:text-white hover:text-shadow-white transition ease-in-out duration-200"
                    >
